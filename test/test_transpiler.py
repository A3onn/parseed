...
def test_getStructs():
    ...
    assert len(res) == 1
    assert res[0].struct_name_token.value == "test"
    ...
    assert len(res) == 2
    assert res[0].struct_name_token.value == "test"
    assert res[1].struct_name_token.value == "test2"
    ...
    assert len(res) == 2
    assert res[0].struct_name_token.value == "test"
    assert res[1].struct_name_token.value == "test3"
...
def test_getBitfields():
    ...
    assert len(res) == 1
    assert res[0].bitfield_name_token.value == "test"
    ...
    assert len(res) == 2
    assert res[0].bitfield_name_token.value == "test"
    assert res[1].bitfield_name_token.value == "test2"
    ...
    assert len(res) == 2
    assert res[0].bitfield_name_token.value == "test"
    assert res[1].bitfield_name_token.value == "test3"